        ...
        <div className="info-section">
          ...
          <div className="skills-section">
            ...
            <div className="skills-content">
              {[
                'TypeScript', 'JavaScript', 'Java', 'Python', 'React', 'React Native',
                'CSS', 'HTML', 'Node.js', 'Firebase', 'C++', 'Docker', 'Vite', 'Vue.js', 'Linux', 'Next.js',
                'Kubernetes', 'Google Cloud', 'FastAPI', 'UI/UX Design'
              ].map((skill, index) => (
                <span
                  key={index}
